...
var recordsAdd = map[string][]Record{
	"example.com.": []Record{
		...
		{Name: "mx1", Type: "A", Target: "1.2.3.6", ClusterID: "localhost1", Online: true},
		{Name: "leastconnected", Type: "A", Target: "1.2.3.4", ClusterID: "localhost1", Online: true, Statistics: Statistics{Connected: 2}, BalanceMode: "leastconnected"},
		{Name: "leastconnected", Type: "A", Target: "127.0.0.1", ClusterID: "localhost1", Online: true, Statistics: Statistics{Connected: 1}, BalanceMode: "leastconnected"},
		{Name: "roundrobin", Type: "A", Target: "1.2.3.4", ClusterID: "localhost1", Online: true, Statistics: Statistics{Requests: 2}, BalanceMode: "roundrobin"},
		{Name: "roundrobin", Type: "A", Target: "127.0.0.1", ClusterID: "localhost1", Online: true, Statistics: Statistics{Requests: 1}, BalanceMode: "roundrobin"},
		{Name: "leasttraffic", Type: "A", Target: "1.2.3.4", ClusterID: "localhost1", Online: true, Statistics: Statistics{TX: 2, RX: 2}, BalanceMode: "leasttraffic"},
		{Name: "leasttraffic", Type: "A", Target: "127.0.0.1", ClusterID: "localhost1", Online: true, Statistics: Statistics{TX: 1, RX: 1}, BalanceMode: "leasttraffic"},
...
var recordsRemove = map[string][]Record{
	"example.com.": []Record{
		{Name: "www2", Type: "A", Target: "1.2.3.4", ClusterID: "localhost1", Online: true},
	},
}
...
func TestExample(t *testing.T) {
	...
	m.AllowForwarding([]net.IPNet{*ipnet})
	m.AllowXfer([]net.IPNet{*ipnet})
	...
	*/
	...
	for domain, records := range recordsRemove {
		for _, record := range records {
			dnscache.Remove(domain, record)
		}
	}

	//m.Start()
	t.Run("queryCalls", func(t *testing.T) {
		t.Run("StaticQueries", testStaticQueries)
		t.Run("BalancedQueries", testBalancedQueries)
		t.Run("ForwardQueries", testForwardQueries)
		t.Run("AxferQueries", testAxferQueries)
	})
...
func testAxferQueries(t *testing.T) {
	t.Parallel()
